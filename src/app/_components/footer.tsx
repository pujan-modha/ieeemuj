...
export default function Footer() {
    return(
        <>
            <div id="footer" className="bottom-0 mb-0 w-full z-20 min-h-96 text-white">
               <div className="max-w-7xl mx-auto px-[5vw]">
                   <div className="grid grid-cols-1 lg:grid-cols-2 text-white text-sm font-medium py-20 lg:py-24">
                       <div className="flex flex-col">
                           <div className="flex flex-row mx-auto lg:mx-0 lg:scale-90">
                               <div className="border-r-2">
                                   {/* eslint-disable-next-line @typescript-eslint/no-unsafe-assignment */}
                                   <Image src={logo} alt="logo" className="w-72 pr-6"/>
                               </div>
                               <div className={`font-sans ${montserrat.variable} grid grid-rows-2 leading-none my-auto pl-6`}>
                                   <p className="text-[1.7rem] font-medium">Student Branch</p>
                                   <p className="text-[1.15rem] font-light">Manipal University Jaipur</p>
                               </div>
                           </div>
                           <div className="flex flex-col lg:flex-row lg:justify-around pt-6 lg:mx-8 lg:scale-90 text-base font-medium space-y-2">
                       ...
                       <div className="grid lg:grid-cols-2 pt-2">
                           <div className="flex flex-col">
                               <div className="pt-8 lg:pt-0 lg:pb-4">
                                   ...
                                   <ul>
                                       <li><Link href="tel:+919721490618" className="inline-flex"><FontAwesomeIcon icon={faSquarePhone} size="lg"/><p className="pl-1">+91 97214 90618</p></Link></li>
                                       <li>Sriansh Raj</li>
                                   </ul>
                                   <br/>
                                   <ul>
                                       <li><Link href="tel:+919569516125" className="inline-flex"><FontAwesomeIcon icon={faSquarePhone} size="lg"/><p className="pl-1">+91 95695 16125</p></Link></li>
                                       <li>Atul Raj Sharma</li>
                                   </ul>
                                   <br/>
                                   <ul>
                                       <li><Link href="mailto:ieee@muj.manipal.edu" className="inline-flex"><FontAwesomeIcon icon={faSquareEnvelope} size="lg"/><p className="pl-1">ieee@muj.manipal.edu</p></Link></li>
                                   </ul>
                               </div>
                               <div className="pt-8 lg:pt-4">
                                   <p className="text-xl font-medium pb-2">Address</p>
                                   <p className="pr-16 leading-6">Manipal University Jaipur, Dehmi Kalan, Near GVK Toll Plaza, Jaipur-Ajmer Expressway, Jaipur, Rajasthan 303007</p>
                               </div>
                           </div>
                           <div className="flex flex-col">
                               <div className="pt-8 lg:pt-0 lg:pb-4">
